...
<nav class="navigation__nav">
    ...
    <ul class="navigation__list">
        ...
        <li class="navigation__item"><a href="projects.html" class="navigation__link">Service</a></li>
...
<div class="talk">
    <div class="talk__box1">
        ...
        <div class="talk__para">Ready to take it to the next level? Contact us today and find out how our
            expertise
            can help your business grow.</div>
    </div>
    <div class="talk__box2">
        <button class="talk__btn"><a href="" class="talk__btn-text"> learn more</a></button>
    </div>
</div>
</main>
...
<footer class="footer">
    ...
    <div class="footer__con2">
        <div class="footer__box">
            <div class="footer__content">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, eaque recusandae
                adipisci sunt maxime ipsum </div>
        </div>
        <div class="footer__box">
            <div class="footer__content">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, eaque recusandae
                adipisci sunt maxime ipsum</div>
